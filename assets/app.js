...
%o`, message, error2, detail);
  ...
  // node_modules/stimulus-scroll-reveal/dist/stimulus-scroll-reveal.mjs
  ...
  var shallowReactiveHandlers = /* @__PURE__ */ extend2(
    {},
    mutableHandlers,
    {
      get: shallowGet,
  ...
  var shallowReadonlyHandlers = /* @__PURE__ */ extend2(
    {},
    readonlyHandlers,
    {
  ...
  function normalizePropsOptions(comp, appContext, asMixin = false) {
    ...
    if (isArray(raw)) {
      ...
      for (const key in raw) {
        ...
        if (validatePropName(normalizedKey)) {
          const opt = raw[key];
          const prop = normalized[normalizedKey] = isArray(opt) || isFunction(opt) ? { type: opt } : extend2({}, opt);
          if (prop) {
...
Component that was made reactive: `,
  ...
  var rendererOptions = /* @__PURE__ */ extend2({ patchProp }, nodeOps);
  var renderer;
...
${codeFrame}` : message);
  ...
  // src/controllers/tab_controller.js
  var tab_controller_default = class extends Controller {
    ...
    showTab(e) {
      ...
      this.contentTargets.forEach((e2) => e2.classList.add("hidden"));
      this.element.querySelectorAll(`.${className}`).forEach((e2) => {
        e2.classList.remove("hidden");
      });
    }
  };
  __publicField(tab_controller_default, "targets", ["content"]);
  ...
  // src/controllers/carousel_controller.js
  ...
  __publicField(carousel_controller_default, "targets", ["wrapper", "picker", "content", "dot"]);

  // src/controllers/menu_scroll_controller.js
  var menu_scroll_controller_default = class extends Controller {
    connect() {
  ...
  __publicField(menu_scroll_controller_default, "targets", ["menu"]);

  // src/controllers/nav_menu_controller.js
  var nav_menu_controller_default = class extends Controller {
    connect() {
  ...
  __publicField(nav_menu_controller_default, "targets", ["open", "close", "nav"]);

  // src/app.js
  var application = Application.start();
  application.register("scroll-reveal", r);
  application.register("tab", tab_controller_default);
  application.register("modal", modal_controller_default);
  application.register("carousel", carousel_controller_default);
  application.register("menu-scroll", menu_scroll_controller_default);
  application.register("nav-menu", nav_menu_controller_default);
